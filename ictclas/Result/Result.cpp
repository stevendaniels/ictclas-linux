...
bool CResult::Sort()
{
    ...
    {//Computing the possibility
        ...
        my_debug(6, "Sort: possibility (%d) = %g\n", i, dPossibility[i]);
...
bool CResult::ParagraphProcessing(char *sParagraph,char *sResult)
{
    ...
    sSentenceResult=new char[nLen*50];//malloc buffer
    sSentence[0]=0;
...
bool CResult::FileProcessing(char *sSourceFile,char *sResultFile)
{
    ...
    int nLineIndex=1;
    sParagraph=new char[40*1024];
    sParagraphResult=new char[80*1024];
